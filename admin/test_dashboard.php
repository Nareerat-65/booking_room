...
/*
 ตารางที่มี:
 - bookings          (1 booking = 1 คำขอ)
 - rooms             (ห้องทั้งหมด)
 - room_allocations  (การจัดสรรห้องให้ booking นั้น ๆ ในช่วง start_date - end_date)
 - room_guests       (รายชื่อผู้เข้าพักจริง)
*/
...
<head>
    ...
    <style>
        ...
        /* ถ้าต้องการเปลี่ยนไอคอนตอน active ให้เป็นสีขาว */
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                        <li class="nav-item">
                            <a href="test_dashboard.php" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="test_change_password.php" class="nav-link">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box" style="background:#F57B39; color:white;">
                                ...
                                <a href="test_requests.php" class="small-box-footer text-white">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                <a href="test_requests.php" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success text-white">
                                ...
                                <a href="test_calendar.php" class="small-box-footer text-white">
